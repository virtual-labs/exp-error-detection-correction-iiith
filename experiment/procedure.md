...
4. Proceed to the next row and repeat the same procedure for the next coset leader.
5. You can enter the coset leader in a field only if the coset leader in the previous row has been entered correctly. Once you have entered all the coset leaders correctly, the standard array table will be complete.
